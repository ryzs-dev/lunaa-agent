...
const metaRouter = express_1.default.Router();
// ============================================================================
...
metaRouter.get("/stats", async (req, res) => {
    try {
        ...
        const stats = {
            products: {
                total: (productStats === null || productStats === void 0 ? void 0 : productStats.length) || 0,
                active: (productStats === null || productStats === void 0 ? void 0 : productStats.filter((p) => p.is_active).length) || 0,
                inactive: (productStats === null || productStats === void 0 ? void 0 : productStats.filter((p) => !p.is_active).length) || 0,
                categories: [
                    ...new Set(productStats === null || productStats === void 0 ? void 0 : productStats.map((p) => p.category).filter(Boolean)),
                ].length,
            },
            packages: {
                total: (packageStats === null || packageStats === void 0 ? void 0 : packageStats.length) || 0,
                active: (packageStats === null || packageStats === void 0 ? void 0 : packageStats.filter((p) => p.is_active).length) || 0,
                inactive: (packageStats === null || packageStats === void 0 ? void 0 : packageStats.filter((p) => !p.is_active).length) || 0,
            },
            orders: {
                total: (orderStats === null || orderStats === void 0 ? void 0 : orderStats.length) || 0,
                totalRevenue: (orderStats === null || orderStats === void 0 ? void 0 : orderStats.reduce((sum, order) => sum + (order.total_amount || 0), 0)) || 0,
                avgOrderValue: (orderStats === null || orderStats === void 0 ? void 0 : orderStats.length) > 0
                    ? orderStats.reduce((sum, order) => sum + (order.total_amount || 0), 0) / orderStats.length
                    : 0,
                byStatus: (orderStats === null || orderStats === void 0 ? void 0 : orderStats.reduce((acc, order) => {
    ...
    try {
        ...
        if (errors.length > 0) {
            return res.status(500).json({
                ...
                details: errors.map((e) => e === null || e === void 0 ? void 0 : e.message).join(", "),
            });
        }
        res.json({
            success: true,
...
metaRouter.get("/dashboard", async (req, res) => {
    try {
        ...
        const { count: totalCustomers } = await supabaseNormalized_1.supabase
            ...
            .select("*", { count: "exact", head: true });
        // Calculate metrics
        const totalRevenue = (recentOrders === null || recentOrders === void 0 ? void 0 : recentOrders.reduce((sum, order) => sum + (order.total_amount || 0), 0)) || 0;
        const totalOrders = (recentOrders === null || recentOrders === void 0 ? void 0 : recentOrders.length) || 0;
        const avgOrderValue = totalOrders > 0 ? totalRevenue / totalOrders : 0;
        // Group orders by status
        const ordersByStatus = (recentOrders === null || recentOrders === void 0 ? void 0 : recentOrders.reduce((acc, order) => {
            acc[order.status || "unknown"] =
                (acc[order.status || "unknown"] || 0) + 1;
            return acc;
        }, {})) || {};
        ...
        for (let i = 6; i >= 0; i--) {
            ...
            const dayRevenue = (recentOrders === null || recentOrders === void 0 ? void 0 : recentOrders.filter((order) => order.order_date >= dayStart && order.order_date <= dayEnd).reduce((sum, order) => sum + (order.total_amount || 0), 0)) || 0;
            revenueByDay.push({
        ...
        res.json({
            ...
            data: {
                ...
                ordersByStatus,
                revenueByDay,
                recentOrders: (recentOrders === null || recentOrders === void 0 ? void 0 : recentOrders.slice(0, 10)) || [], // Last 10 orders
            },
        });
    }
    catch (error) {
