...
function parseAddress(addressLine) {
    ...
    function extractPostcode(regex) {
        ...
        for (const match of matches) {
            ...
            const surroundingText = address.substring(Math.max(0, idx - 15), idx + match.length + 15);
    ...
    if (!state && postcode) {
        ...
        if (postcode.length === 5) {
            if (postcodeNum >= 40000 && postcodeNum <= 48999)
                state = "Selangor";
            else if (postcodeNum >= 50000 && postcodeNum <= 60999)
                state = "Kuala Lumpur";
            else if (postcodeNum >= 10000 && postcodeNum <= 14999)
                state = "Penang";
            else if (postcodeNum >= 79000 && postcodeNum <= 86999)
                state = "Johor";
            else if (postcodeNum >= 30000 && postcodeNum <= 36999)
                state = "Perak";
            else if (postcodeNum >= 5000 && postcodeNum <= 9999)
                state = "Kedah";
            else if (postcodeNum >= 15000 && postcodeNum <= 18999)
                state = "Kelantan";
            else if (postcodeNum >= 20000 && postcodeNum <= 24999)
                state = "Terengganu";
            else if (postcodeNum >= 25000 && postcodeNum <= 29999)
                state = "Pahang";
            else if (postcodeNum >= 70000 && postcodeNum <= 73999)
                state = "Negeri Sembilan";
            else if (postcodeNum >= 75000 && postcodeNum <= 78999)
                state = "Melaka";
            else if (postcodeNum >= 1000 && postcodeNum <= 2999)
                state = "Perlis";
            else if (postcodeNum >= 87000 && postcodeNum <= 91999)
                state = "Sabah";
            else if (postcodeNum >= 93000 && postcodeNum <= 98999)
                state = "Sarawak";
            else if (postcodeNum >= 62000 && postcodeNum <= 62999)
                state = "Putrajaya";
            else if (postcodeNum >= 87000 && postcodeNum <= 87999)
                state = "Labuan";
        }
