...
class OrderTrackingService {
  ...
  async addTrackingEntry(entryData: OrderTrackingInput, orderId: UUID) {
    return await this.orderTrackingDatabase.addTrackingEntry(
      entryData,
      orderId
    );
  }
  ...
  async getTrackingEntriesByOrderId(orderId: string) {
    return await this.orderTrackingDatabase.getTrackingEntriesByOrderId(
      orderId
    );
  }
  ...
  async updateTrackingEntry(
    ...
    return await this.orderTrackingDatabase.updateTrackingEntry(
      entryId,
      updates
    );
  }
